      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-400">
            Your personal, private bookmark manager.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-6">
          <button
            onClick={handleLogin}
            disabled={loading}
            className="group relative flex w-full items-center justify-center gap-3 overflow-hidden rounded-lg bg-white px-6 py-4 text-gray-900 transition-all hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-70"
          >
            {loading ? (
        ...
        <div className="absolute -top-10 -left-10 h-32 w-32 rounded-full bg-blue-500/20 blur-3xl"></div>
